...
define("LAN_MAILOUT_166", "Generell feil slette post ref:  [x]");
define("LAN_MAILOUT_167", "Feil slette post innhold ref:  [x]");
define("LAN_MAILOUT_168", "Post innhold slettet ref:  [x]");
define("LAN_MAILOUT_169", "Feil slette post mottakerne ref:  [x]");
define("LAN_MAILOUT_170", "Slettet - NUM - mottakere av e-post ref: [x]");
define("LAN_MAILOUT_171", "Bekreft sletting av e-post");
define("LAN_MAILOUT_172", "Post Type/Status");
define("LAN_MAILOUT_173", "Mottakere");
define("LAN_MAILOUT_174", "Sikkerhetskontroll mislykkes:  [x]  [z]");
...
define("LAN_MAILOUT_186", "Generell feil ved å legge til mailref: [x] på vent");
define("LAN_MAILOUT_187", "Gmail [x] satt på vent");
define("LAN_MAILOUT_188", "Generell feil sende mail ref: [x]");
...
define("LAN_MAILOUT_206", "Ugyldig post ID ([x]) angitt");
...
define("LAN_MAILOUT_220", "Email ID [x] avbrutt");
define("LAN_MAILOUT_221", "Feil ved å kansellere e-post med ID [x]");
...
define("LAN_MAILOUT_226", "[x]  foreldreløse mottaker post(er) fjernet");
define("LAN_MAILOUT_227", "Slettet [x]  poster fra [y] ");
define("LAN_MAILOUT_228", "[x] uregelmessigheter i mail_content rettet; poster: [y] ");
define("LAN_MAILOUT_229", "Email ID [x]  settes på vent");
define("LAN_MAILOUT_230", "Feil med e-post med ID [x]");
...
define("LAN_MAILOUT_237", "Sammendrag tellere oppdatert på [x] e-post");
